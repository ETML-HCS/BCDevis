...
if not exist "%BROWSER%" (
  echo Edge ou Chrome est necessaire pour lancer Bellecour Devis.
  pause
  exit /b 1
)
...
start "Bellecour Devis" "%BROWSER%" --user-data-dir="%PROFILE_DIR%" --no-first-run --no-default-browser-check --app="%APP_URL%"
exit /b 0
