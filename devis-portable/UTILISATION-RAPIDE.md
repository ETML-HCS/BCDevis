<div class="document-cover">
  ...
  <p class="version">Version 7.1.2 - Windows, Linux, macOS, ChromeOS et iPadOS</p>
</div>
...
Double-cliquez sur `BCDevis-7.1.2.exe`. Aucun programme d'installation n'est nécessaire.
...
```bash
chmod +x BCDevis-7.1.2-linux-x86_64.AppImage
./BCDevis-7.1.2-linux-x86_64.AppImage
```
...
La version ChromeOS est une PWA. L'archive `BCDevis-7.1.2-chromeos.zip` doit d'abord être décompressée et son dossier `site` publié sur une adresse HTTPS.
