<div class="document-cover">
  ...
  <p class="version">BCDevis 5.1.0</p>
</div>
...
Le fichier `MODELE-DEVIS-V5.json` est un devis vierge compatible avec BCDevis 5.1.0.
...
3. adaptez le client, la date, les quantités et les prix ;
